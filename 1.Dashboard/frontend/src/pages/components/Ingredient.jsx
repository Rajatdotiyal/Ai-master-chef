    ...
    <>
              ...
              <div className="flex flex-col lg:flex-row gap-0 lg:gap-4">
                <div className="w-full lg:w-1/2 pt-4 lg:pt-0">
                  ...
                  <input
                    ...
                    className={`custom-input custom-text ${portion !== 1 ? "cursor-not-allowed" : "cursor-text"
                      } px-2 mt-2 py-1 text-lg w-full border border-black rounded-md focus:border-orange-400 placeholder:italic outline-none`}
                  />
                </div>

               <select className={`custom-input custom-text ${portion !== 1 ? "cursor-not-allowed" : "cursor-pointer"} px-2 mt-2 py-[7px] text-lg w-full border border-black rounded-md focus:border-orange-400 placeholder:italic outline-none`}
                                    >
      ...
      <div className="w-full lg:w-1/2 pt-4 lg:pt-0">
        ...
        <input
          ...
          placeholder="eg. 200"
          className={`custom-input custom-text ${portion !== 1 && isQuantityDisabled
            ? "cursor-not-allowed"
            : "cursor-text"
